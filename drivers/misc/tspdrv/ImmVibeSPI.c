...
/*
// LGE_CHANGE_S [yehan.ahn@lge.com] 2011-02-25, [LGE_AP20] pwm_pin -> output_mode
	g_vib->h_vib_gpio_pin = NvOdmGpioAcquirePinHandle( g_vib->h_vib_gpio, 'u' - 'a' , 3 );
...
// LGE_CHANGE_E [yehan.ahn@lge.com] 2011-02-25
*/ // GPIO u3 is used for USIF1_SW in SU660/P990
