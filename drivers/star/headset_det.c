...
#if defined(CONFIG_MACH_STAR_SKT_REV_E)//jongik2.kim 20100910 i2c_fix 
...
#if !defined(CONFIG_MACH_STAR_SKT_REV_E) //20101103 seki.par@lge.com heaset detect time[LGE_LAB1]
...
#if defined(CONFIG_MACH_STAR_SKT_REV_E) //20101005 seki.par@lge.com Gpio MicBias[LGE_LAB1]
...
//20101005 seki.park@lge.com CONFIG_MACH_STAR_SKT_REV_E Add [START_LGE_LAB1]
#if !defined(CONFIG_MACH_STAR_SKT_REV_E)//Global
...
#else //CONFIG_MACH_STAR_SKT_REV_E
static void type_det_work(struct work_struct *work)
{
    NvU32 hook_value =0;
...
#endif
//20101005 seki.park@lge.com CONFIG_MACH_STAR_SKT_REV_E Add [END_LGE_LAB1]
